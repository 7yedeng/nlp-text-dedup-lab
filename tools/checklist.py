...
def main():
    ...
    # ---------------- 提交要求 ----------------
    rep = os.path.join(OUT, "<成员一姓名>+<成员一学号>+第1次实验报告.docx")
    items.append(("提交", "Word 实验报告",
                  os.path.exists(rep), os.path.basename(rep)))
    items.append(("提交", "报告命名：姓名+学号+…+第1次实验报告.docx",
                  os.path.exists(rep), "<成员一姓名>+<成员一学号>+第1次实验报告.docx"))
    ...
    items.append(("提交", "代码压缩包（不含第三方库与大模型）",
                  os.path.exists(os.path.join(ROOT, "提交材料",
                                              "<成员一姓名>+<成员一学号>+第1次实验-代码.zip")),
                  "提交材料/…-代码.zip"))
